...
builder.Services.AddDbContext<HobbyshopContext>(options => options.UseSqlServer(connectionString));
...
{
    options.IdleTimeout = TimeSpan.FromMinutes(20); // the duration a Session is stored in the app memory
